				...
				<div class="home__slider-sec-wrap">
						...
						<ul class="header__category-list">
							<li class="header__category-list-item item-has-submenu">
								<a href="category-product.html" class="header__category-list-item-link">
									<img src="{{asset('frontent/assets/images/product.png')}}" alt="category">
									Test Category
								</a>
					...
					<div class="home__slider-items-wrapper">
						<div class="home__slider-item-outer">
							<img src="{{asset('frontent/assets/images/slider.jpg')}}" alt="image" class="home__slider-item-image">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="banner-item-outer">
							<img src="{{asset('frontent/assets/images/banner.jpeg')}}" alt="banner image" />
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="banner-item-outer">
					...
					<div class="product__item-outer">
						<div class="product__item-image-outer">
							<a href="details.html" class="product__item-image-inner">
								<img src="{{asset('frontent/assets/images/product.png')}}" alt="Product Image" />
							</a>
			...
			<div class="container">
				...
				<div class="product-items-wrapper">
					<div class="product__item-outer">
						<div class="product__item-image-outer">
							<a href="details.html" class="product__item-image-inner">
								<img src="{{asset('frontent/assets/images/product1.jpg')}}" alt="Product Image" />
							</a>
							<div class="product__item-add-cart-btn-outer">
								<a href="details.html" class="product__item-add-cart-btn-inner">
									Add to Cart
